...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <div class="nav-item">
                <a href="<?php echo e(route('suppliers.index')); ?>" class="nav-link <?php echo e(request()->routeIs('suppliers.index') ? 'active' : ''); ?>">
    ...
    <div class="main-content">
        <!-- Topbar -->
        <div class="topbar">
            <h5 class="m-0 font-weight-bold"><?php echo $__env->yieldContent('page_title', 'Stratos Procurement'); ?></h5>
            <div class="d-flex align-items-center">
                ...
                <div class="d-flex align-items-center gap-2">
                    <div class="text-end d-none d-md-block">
                        <div style="font-size: 0.88rem; font-weight: 600; color: #0b224e; line-height: 1;"><?php echo e(auth()->user()->first_name); ?> <?php echo e(auth()->user()->last_name); ?></div>
                        <div style="font-size: 0.75rem; color: #6c757d;"><?php echo e(ucfirst(strtolower(auth()->user()->role))); ?></div>
                    </div>
...
<?php /**PATH C:\Users\fredy\OneDrive\Documentos\project-final\project-compras\resources\views/layouts/app.blade.php ENDPATH**/ ?>